...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <!-- /.box-header -->
            <form action="{{ route('admin_questionaire.editQuestion', ['questionaire_id' => $questionaire_id, 'id' => $question->id]) }}" id="question-form" method="POST" accept-charset="UTF-8" class="form-horizontal">
                <!-- Box body -->
                <div class="box-body">
