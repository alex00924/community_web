            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <div class="btn-group pull-right" style="margin-right: 5px">
                        <a href="{{ $category === 'questionaire' ? route('admin_questionaire.indexQuestion', ['questionaire_id' => $questionaire_id]) : route('admin_marketquestionaire.indexQuestion', ['questionaire_id' => $questionaire_id]) }}" class="btn  btn-flat btn-default" title="List"><i
                                class="fa fa-list"></i><span class="hidden-xs"> {{trans('questionaire.admin.back_questionaire_hierarchy')}}</span></a>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
            <form action="{{ $category === 'questionaire' ? route('admin_questionaire.editQuestion', ['questionaire_id' => $questionaire_id, 'id' => $question->id]) : route('admin_marketquestionaire.editQuestion', ['questionaire_id' => $questionaire_id, 'id' => $question->id]) }}" id="question-form" method="POST" accept-charset="UTF-8" class="form-horizontal">
                <!-- Box body -->
                <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('question') ? ' has-error' : '' }}">
                            ...
                            <div class="col-xs-8">
                                <textarea id="question" name="question" class="form-control input-sm" rows="5" 
                                    required>{{ empty(old('question')) ? $question->question : old('question') }}</textarea>
