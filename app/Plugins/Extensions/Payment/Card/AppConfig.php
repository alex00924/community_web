...
class AppConfig extends ConfigDefault
{
        ...
        if ($check) {
            ...
            $configCard = [
                ...
                [
                    ...
                    'sort' => 0, // Sort extensions in group
                    'value' => '',
                    'detail' => $this->pathPlugin.'::'.$this->configKey . '.card_client_id',
                ],
                [
                    'group' => '',
                    'code' => 'card_config',
    ...
    public function uninstall()
    {
        ...
        $process2 = (new AdminConfig)->whereIn('key', ['card_client_id', 'card_secrect', 'card_currency', 'card_order_status_success', 'card_order_status_faild'])->delete();
        if (!$process & !$process2) {
